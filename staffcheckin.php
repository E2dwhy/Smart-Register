    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="intro-text">
          ...
          <div class="header">
  	<h2 style="color:white;" font-size="5px">Staff Cehckin</h2>
  </div>
	
  <form method="post" action="staffcheckin.php">
  <?php include('errors.php'); ?>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Name</label>
  	  <input type="text" name="sname" value="" placeholder="Name">
  	</div>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Service Type</label>
  	  <input type="purpose" name="services" value="" placeholder="services">
  	</div>
  	<div class="input-group">
...
-->
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="staffcheckin">Checkin</button>
  	</div>
  </form>
