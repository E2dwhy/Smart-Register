...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body id="page-top">
    ...
    <div class="header">
  	<h3 style="color:white;">New Resident</h3>
  </div>
	
  <form method="post" action="newresident.php">
  	<?php include('errors.php'); ?>
  	<div class="input-group">
  	  <label>rname</label>
  	  <input type="text" name="rname" placeholder="Resident Name" value="<?php echo $username; ?>">
  	</div>
  	<div class="input-group">
  	  <label>Email</label>
  	...
  	<div class="input-group">
  	  <label>Flat No</label>
  	  <input type="text" name="flatno" placeholder="Flat No">
  	</div>
    <div class="input-group">
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="addresident">Add</button>
  	</div>
  </form>
  <h1>Residents Records</h1>
	<table class="data-table">
		<caption class="title">Over All Residents Records</caption>
		<thead>
			<tr>
				<th>Resident Name</th>
        <th>Email </th>
		...
		{
			$resident  = $row['rname'] == 0 ? '' : number_format($row['rname']);
			echo '<tr>
					<td>'.$row['rname'].'</td>
					<td>'.$row['email'].'</td>
					<td>'.$row['mobno'].'</td>
