...
$sql = 'SELECT * FROM visitorcheckin';
...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php#page-top">Smart Register</a>
		  ...
		  <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="admin.html" style="color:rgb(255, 196, 0);" >Menu</a>
            </li>
            <li class="nav-item">
	...
	<table class="data-table">
		<caption class="title">Over All visitors Records</caption>
		<thead>
			<tr>
				<th>Visitor Name</th>
                <th>Purpose</th>
		...
		{
			$resident  = $row['vname'] == 0 ? '' : number_format($row['vname']);
			echo '<tr>
					<td>'.$row['vname'].'</td>
					<td>'.$row['purpose'].'</td>
