...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php#page-top">Smart Register</a>
		  ...
		  <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="javascript:history.go(-1)" style="color:rgb(255, 196, 0);" >Back</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="logout.php" style="color:rgb(255, 196, 0);" >Logout</a>
            </li>
          </ul>
	...
	<table class="data-table">
		<caption class="title">Notifications to Gate</caption>
		<thead>
			<tr>
				<th>Resident Name</th>
				<th>Apartment No</th>
		...
		{
			$resident  = $row['resident'] == 0 ? '' : number_format($row['resident']);
			echo '<tr>
					<td>'.$row['resident'].'</td>
					<td>'.$row['apartno'].'</td>
					<td>'.$row['vtype'].'</td>
