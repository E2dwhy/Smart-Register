...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body id="page-top">
    ...
    <div class="header">
      <h3 style="color:white;">Notify Gate</h3>
  </div>
	
  <form method="post" action="notifygate.php">
  	<?php include('errors.php'); ?>
  	<div class="input-group">
  	  <label>Resident</label>
  	  <input type="text" name="resident" placeholder="Resident Name" ">
  	</div>
  	<div class="input-group">
  	  <label>Flat No</label>
  	  <input type="text" name="apartno" placeholder="Flat No" >
  	</div>
  	<div class="input-group">
      ...
      <option value="Delivery" name="delivery">delivery</option>
       ...
       <option value="Tuition" name="tuition">tuition</option>
       <option value="Helper" name="helper">helper</option>
       <option value="Casual" name="casual">casual</option>
       <option value="cab" name="cab">cab</option>
      </select>
  	</div>
  	<div class="input-group">
  	  <label>Expected Time</label>
  	  <input type="time" name="vtime" placeholder="time">
  	</div>
  	<div class="input-group">
  	  <button type="submit" class="btn" name="notify">Notify</button>
  	</div>
  </form>
