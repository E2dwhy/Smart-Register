    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="intro-text">
          ...
          <div class="header">
  	<h2 style="color:white;" font-size="5px">Cab Pick Up</h2>
  </div>
	
  <form method="post" action="cab.php">
  <?php include('errors.php'); ?>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Driver Name</label>
  	  <input type="text" name="dname" value="" placeholder="Name">
  	</div>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Client Name</label>
  	  <input type="persont_to_visit" name="cltname" value="" placeholder="Client Name">
  	</div>
    <div class="input-group">
    ...
    <div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Vehicle Number</label>
  	  <input type="vehicle_no" name="v_no" value="" placeholder="Vehicle No">
    </div>
    <div class="input-group">
    ...
    <br>
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="validatecab">Validate</button>
  	</div>
  </form>
