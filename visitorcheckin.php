...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="intro-text">
          ...
          <div class="header">
  	<h2 style="color:white;" font-size="5px">Visitors Checkin</h2>
  </div>
	
  <form method="post" action="visitorcheckin.php">
  <?php include('errors.php'); ?>
  	...
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Purpose</label>
  	  <input type="purpose" name="purpose" value="" placeholder="Purpose">
  	</div>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Person To Visit</label>
...
-->
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="checkin">Checkin</button>
  	</div>
  </form>
