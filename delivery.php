    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="intro-text">
          ...
          <div class="header">
  	<h2 style="color:white;" font-size="5px">Delivery</h2>
  </div>
	
  <form method="post" action="delivery.php">
  <?php include('errors.php'); ?>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Name</label>
  	  <input type="text" name="dname" value="" placeholder="Name">
  	</div>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Company</label>
  	  <select name="company">
        <option value="amazon">Amazon</option>
        <option value="flipkart">Flipkart</option>
        <option value="reliance">Reliance</option>
        <option value="bigbazzar">Big Bazzar</option>
        <option value="snapdeal">Snapdeal</option>
        <option value="others">Others</option>
      </select>
  	</div>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Person For Services</label>
  	  <input type="persont_to_visit" name="rname" value="" placeholder="Person to visit">
  	</div>
  	<div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Apart Number</label>
  	  <input type="apart_no" name="apart_no" value="" placeholder="Apart No">
    </div>
    <div class="input-group">
  	  <label style="color:rgb(255, 196, 0);">Phone Number</label>
  	  <input type="phone_no" name="phone_no" value="" placeholder="Mobile No">
    </div>
    <div class="input-group">
    <label style="color:rgb(255, 196, 0);">Date and Time</label>
    <input id="date" name="date_time">
...
-->
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="deliver">Validate</button>
  	</div>
  </form>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright © Smart Register 2018</span>
          </div>
          <div class="col-md-4">
